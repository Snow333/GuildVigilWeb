 ...
 * Every consumer (summary today; beat feed, deeds, forecast in Phase 2)
 * must parse this stream. It is deliberately hand-built — when the real
 * sim exists, a generated fixture joins it; this one stays as the frozen
 * minimal contract.
 *
